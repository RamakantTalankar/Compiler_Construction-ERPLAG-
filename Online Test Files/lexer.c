...
void ht_init(map mp)
{
    ...
    insert_hashtable(mp, "Record", "RECORD");
    insert_hashtable(mp, "Field", "FIELD");
    insert_hashtable(mp, "printscope", "PRINTSCOPE");
    insert_hashtable(mp, "NOT", "NOT");
}
...
TOKEN getNextToken(FILE *fp, map mp)
{
    ...
    while (1)
    {
        ...
        case 102: 
            ...
            // mytkn.token = "IMPLICITID";
            // mytkn.value_id=lexeme;
            // state = 0;
            // return mytkn;
            ...
            else
            {
                ...
                mytkn.token = "IMPLICITID"; // if not a keyword
